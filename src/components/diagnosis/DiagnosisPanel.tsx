...
export function DiagnosisPanel({alarm,analysis,analysisState='idle',analysisError='',onRefresh}:DiagnosisPanelProps){
 ...
 return <Card title="AI Diagnosis Panel" className="diagnosis">
  ...
  <p className="disclaimer">AI 分析結果僅供維運判斷，實際處置仍需由值班人員確認。</p>
 </Card>
}
