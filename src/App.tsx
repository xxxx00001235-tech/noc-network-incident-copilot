...
import { DiagnosisPage, IncidentsPage } from './pages/OperationsPages';
import { AccountsPage, DevicesPage, LabPage, RegionMapPage, WallboardPage } from './pages/PlatformPages';
