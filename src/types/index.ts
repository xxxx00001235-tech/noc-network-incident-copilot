...
export interface Device {
 id:string; name:string; ip:string; type:string; layer:'Core'|'Distribution'|'Access';
 region:string; site:string; location?:string; status:DeviceStatus; alarms:number;
 owner?:string; ownerUserId?:number|null; backupOwnerUserId?:number|null; description?:string;
 upstream?:string; downstream:string[]; backup?:string; maintenance?:Maintenance; cpu?:number;
}
